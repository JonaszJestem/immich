...
{#if passwordRequired}
  ...
  <main
    class="relative h-screen overflow-hidden px-6 pt-[var(--navbar-height)] dark:bg-immich-dark-bg sm:px-12 md:px-24 lg:px-40  bg-eucalyptus bg-opacity-40 bg-cover bg-no-repeat bg-center"
  >
